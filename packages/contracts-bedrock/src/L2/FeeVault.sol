...
abstract contract FeeVault {
    ...
    function config() public virtual view returns (address recipient_, uint256 amount_, IFeeVault.WithdrawalNetwork network_);
    ...
    function withdrawalNetwork() public view returns (IFeeVault.WithdrawalNetwork withdrawalNetwork_) {
    ...
    ///         and is subject to be removed in the future.
    /// @custom:legacy
    function WITHDRAWAL_NETWORK() external view returns (IFeeVault.WithdrawalNetwork network_) {
        network_ = withdrawalNetwork();
    }

    /// @notice Triggers a withdrawal of funds to the fee wallet on L1 or L2.
    function withdraw() external {
        (address withdrawalRecipient, uint256 withdrawalAmount, IFeeVault.WithdrawalNetwork network) = config();
        ...
        if (network == IFeeVault.WithdrawalNetwork.L2) {
