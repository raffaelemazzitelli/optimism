...
interface IL1Block {
    ...
    function baseFeeVaultConfig() external view returns (address recipient, uint256 amount, IFeeVault.WithdrawalNetwork network);
    function l1FeeVaultConfig() external view returns (address recipient, uint256 amount, IFeeVault.WithdrawalNetwork network);
    function sequencerFeeVaultConfig() external view returns (address recipient, uint256 amount, IFeeVault.WithdrawalNetwork network);
