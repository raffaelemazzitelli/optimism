...
contract L1Block is ISemver, IGasToken {
    ...
    /// @notice
    function baseFeeVaultConfig() public view returns (address recipient, uint256 amount, IFeeVault.WithdrawalNetwork network) {
        return Encoding.decodeFeeVaultConfig(Storage.getBytes32(BASE_FEE_VAULT_CONFIG_SLOT));
    }

    /// @notice
    function l1FeeVaultConfig() public view returns (address recipient, uint256 amount, IFeeVault.WithdrawalNetwork network) {
        return Encoding.decodeFeeVaultConfig(Storage.getBytes32(L1_FEE_VAULT_CONFIG_SLOT));
    }

    /// @notice
    function sequencerFeeVaultConfig() public view returns (address recipient, uint256 amount, IFeeVault.WithdrawalNetwork network) {
